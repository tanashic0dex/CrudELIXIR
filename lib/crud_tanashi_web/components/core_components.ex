defmodule CrudTanashiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CrudTanashiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CrudTanashiWeb.Gettext, "errors", msg, opts)
    end
  end
